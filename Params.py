...
# hemoParamsV1 = {'RAP': [20.0,40.0,60.0,85.0],
#  'PAS': [25.0,50.0,75.0,90.0],
#  'PAD': [15.0,30.0,45.0,59.0],
#  'PAMN': [20.0,40.0,60.0,82.0],
#  'PCWP': [15.0,30.0,45.0,53.0],
#  'PCWPMod': [15.0,30.0,45.0,53.0],
#  'PCWPA': [15.0,30.0,45.0,53.0],
#  'PCWPMN': [15.0,30.0,45.0,49.0],
#  'CO': [6.0,12.0,18.0,25.0],
#  'CI': [1.0,2.0,3.0,4.81],
#  'SVRHemo': [1000,2000,4000,6866],
#  'MIXED': [150,300,450,627.0],
#  'BPSYS': [30,60, 90, 120, 168.0],
#  'BPDIAS': [25, 50, 5, 100, 125],
#  'HRTRT': [25, 50, 5, 100, 125],
#  'RATHemo': [01.0, 2.0, 3.0, 3.74],
#  'MAP': [60, 120, 180, 226],
#  'MPAP': [ 30, 60, 90,129.33],
#  'CPI': [0.4,0.8,1.2,1.82],
#  'PP': [-25,60,100,106],
#  'PPP': [-0.36, 0, 0.3647878179512195,0.74],
#  'PAPP': [0.2,0.4,0.6,0.844],
#  'SVR': [2000,4000,8000,10755.55],
#  'RAT': [1.0, 2.0, 3.0, 3.7368],
#  'PPRatio': [0,3,6, 9.6666],
#  'Age': [53,73,80, 88.0],
#  'EjF': [10.0,20,30,45]}

hemoParamsV1 = {'RAP': [56, 4, 77, 63],
 'PAS': [41, 6, 62, 58],
 'PAD': [55, 32, 38, 5],
 'PAMN': [47, 30, 52, 6],
 'PCWP': [30, 17, 19, 5],
