...
def getBestMVDD(dt, xData, yData, classes, learningCriteria):
    ...
    edgeOptions = genEdgeCombos(percentReqdMin, percentReqdMax, totalEdges, combinationSize=5000, sampleSize=1000) #combinationSize=100000, sampleSize=50000) #changing stuff here
