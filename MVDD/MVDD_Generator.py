...
def getBestMVDD(dt, xData, yData, classes, learningCriteria):
    ...
    #was 3000 and 2000
    edgeOptions = genEdgeCombos(percentReqdMin, percentReqdMax, totalEdges, combinationSize=1000, sampleSize=700)#combinationSize=500, sampleSize=350) #combinationSize=100000, sampleSize=50000) #changing stuff here
