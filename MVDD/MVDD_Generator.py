...
def getBestMVDD(dt, xData, yData, classes, learningCriteria):
    ...
    # was 10000 and 5000
    edgeOptions = genEdgeCombos(percentReqdMin, percentReqdMax, totalEdges, combinationSize=7000, sampleSize=5000)#combinationSize=500, sampleSize=350) #combinationSize=100000, sampleSize=50000) #changing stuff here
